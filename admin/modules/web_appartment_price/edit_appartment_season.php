...
if($view=='list') {
	...
	$regNewPerm=new formButton('Preis hinzufügen',"top.editElement('".table::MODE_NEW."','appartment_pricehasseason','".NO_UID."','".$action['uid']."',true)",ROOT_DIR.'icons/ilist_actions_add.gif');
