...
.tab_header_leftActive {
	/*
	background-image:url(icons/tab_header_leftActive.gif);
...
.tab_header_leftInactive {
	/*
	background-image:url(icons/tab_header_leftInactive.gif);
...
.tab_header_midActive {
	/*
	background-image:url(icons/tab_header_midActive.gif);
...
.tab_header_midInactive {
	/*
	background-image:url(icons/tab_header_midInactive.gif);
	background-repeat:repeat-x;
	height:32px !important;
	*/
	background-color:#FFFFFF;
...
.tab_header_rightActive {
	...
	border-top:2px solid #46b0ee;
	/*
	background-image:url(icons/tab_header_rightActive.gif);
	background-repeat:no-repeat;
	height:32px !important;
	*/
	font-size:1px;
...
.tab_header_rightInactive {
	/*
	background-image:url(icons/tab_header_rightInactive.gif);
	background-repeat:no-repeat;
	height:32px !important;
	*/
	background-color:#FFFFFF;
